...
Future<void> showFinanceInfoSheet({
...
class FinanceSheetLine extends StatelessWidget {
  const FinanceSheetLine({super.key, required this.label, required this.value});
...
class FinanceSheetMessage extends StatelessWidget {
  const FinanceSheetMessage({super.key, required this.message});
