...
Future<void> showProductivityInfoSheet({
...
class ProductivitySheetLine extends StatelessWidget {
  const ProductivitySheetLine({super.key, required this.label, required this.value});
...
class ProductivitySheetMessage extends StatelessWidget {
  const ProductivitySheetMessage({super.key, required this.message});
