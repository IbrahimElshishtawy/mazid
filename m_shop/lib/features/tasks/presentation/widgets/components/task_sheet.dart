    ...
    builder: (context) {
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(color: Color(0x1A0F172A), blurRadius: 30, offset: Offset(0, 16)),
          ],
        ),
        child: SafeArea(
          child: Column(
...
class TaskSheetLine extends StatelessWidget {
  const TaskSheetLine({super.key, required this.label, required this.value});
...
class TaskSheetMessage extends StatelessWidget {
  const TaskSheetMessage({super.key, required this.message});
