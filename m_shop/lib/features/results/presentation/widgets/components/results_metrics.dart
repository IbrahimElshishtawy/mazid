...
class ResultsMetricCard extends StatelessWidget {
  const ResultsMetricCard({super.key, required this.width, required this.title, required this.value, required this.note, required this.accent, required this.icon});
