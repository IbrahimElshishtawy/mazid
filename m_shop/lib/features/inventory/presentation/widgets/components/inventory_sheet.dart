...
Future<void> showInventoryInfoSheet({
...
class InventorySheetLine extends StatelessWidget {
  const InventorySheetLine({super.key, required this.label, required this.value});
...
class InventorySheetMessage extends StatelessWidget {
  const InventorySheetMessage({super.key, required this.message});
