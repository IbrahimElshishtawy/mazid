    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('لوحة تشغيل تنفيذية تساعد الإدارة على متابعة الحالة العامة، قراءة المؤشرات بسرعة، واتخاذ القرار بثقة طوال اليوم.', style: TextStyle(color: Color(0xD7FFFFFF), height: 1.7)),
          ...
          Container(
            ...
            child: const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('رسالة الإدارة اليوم', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w800)),
                SizedBox(height: 8),
                Text('التركيز اليوم على تقليل زمن التوقف، رفع سرعة الاستجابة للتنبيهات، والحفاظ على جودة التشغيل بدون زيادة في الهدر.', style: TextStyle(color: Color(0xD7FFFFFF), height: 1.6)),
              ],
            ),
          ),
          const SizedBox(height: 18),
          const Text('مؤشر المتابعة التنفيذية', style: TextStyle(color: Color(0xD7FFFFFF), fontWeight: FontWeight.w700)),
          ...
          const SizedBox(height: 8),
          const Text('84% من الخطة اليومية تحت السيطرة مع حاجة لمتابعة الجرد والتنبيهات الحرجة.', style: TextStyle(color: Color(0xBFFFFFFF), height: 1.5)),
        ],
      ),
    );
  }
